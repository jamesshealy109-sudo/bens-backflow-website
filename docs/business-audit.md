...
| --- | --- | --- |
| Ben’s Backflow Testing & Repair LLC | Current bensbackflowsc.com website/footer | Business/schema identity |
...
| Greenville, Spartanburg, Anderson and surrounding Upstate communities | Current service-area material | Primary SEO market |
| Statewide South Carolina availability | User confirmation | Secondary/statewide positioning |
...
- No fabricated testimonials, ratings, review counts or certifications.
- No invented office locations outside the verified Upstate base.

## Geographic strategy

The Upstate is the primary local SEO market. The site should clearly communicate statewide South Carolina availability without pretending Ben’s Backflow has local offices in Columbia, Charleston, Myrtle Beach, Rock Hill or other cities outside the Upstate.

## Platform boundary

The public site is the marketing and SEO layer. The StrataWorks Backflow Operations Platform remains the operational system for customer/service workflows. Public CTAs should use configured handoff URLs and must not invent API endpoints.
